...
```
 bwa mem -t 2 ~/Module2/raw_data/reference.fasta  ~/Module2/raw_data/SRR12447392_1.filtered.fastq.gz  ~/Module2/raw_data/SRR12447392_2.filtered.fastq.gz > our_mapped_reads.sam
```
